            ...
            {navItems.map((item) => (
              ...
              >
                <button
                  ...
                  className="text-sm text-gray-900 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium"
                >
                  {item.name}
                </button>
              </motion.div>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          >
            <button
              ...
              className="inline-flex items-center justify-center px-5 py-2 text-sm text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-full hover:from-blue-700 hover:to-blue-800 transition-all shadow-md"
            >
              Get Started
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col space-y-6">
              ...
              >
                <button
                  onClick={handleGetStarted}
                  className="inline-flex items-center justify-center w-full px-5 py-3 text-base text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-full hover:from-blue-700 hover:to-blue-800 transition-all shadow-md"
                >
                  Get Started
                </button>
              </motion.div>
