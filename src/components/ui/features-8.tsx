...
import { Shield, Users, Brain, Zap, FileText, Mic } from 'lucide-react'
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 dark:bg-zinc-800/50 dark:border-zinc-700">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg className="text-muted dark:text-zinc-500 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold dark:text-white">24/7</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold dark:text-white">Always Available</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 dark:bg-zinc-800/50 dark:border-zinc-700">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-zinc-600 dark:before:border-zinc-700">
                                    <Brain className="m-auto size-16 text-blue-600 dark:text-blue-400" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">AI-Powered Learning</h2>
                                    <p className="text-foreground dark:text-gray-300">Advanced AI models provide instant answers, explanations, and personalized learning support.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 dark:bg-zinc-800/50 dark:border-zinc-700">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-zinc-500 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-primary/15 dark:text-blue-400/25" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition dark:text-white">Lightning Fast</h2>
                                    <p className="text-foreground dark:text-gray-300">Get instant responses to your questions with our optimized AI processing engine.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 dark:bg-zinc-800/50 dark:border-zinc-700">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-zinc-600 dark:before:border-zinc-700">
                                        <Shield className="m-auto size-5 text-blue-600 dark:text-blue-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Secure & Private</h2>
                                        <p className="text-foreground dark:text-gray-300">Your data is encrypted and protected with enterprise-grade security standards.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 dark:bg-zinc-800/50 dark:border-zinc-700">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-zinc-600 dark:before:border-zinc-700">
                                        <FileText className="m-auto size-6 text-blue-600 dark:text-blue-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition dark:text-white">Smart Document Analysis</h2>
                                        <p className="text-foreground dark:text-gray-300">Upload PDFs, documents, and get AI-powered insights, summaries, and analysis instantly.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:text-gray-200 dark:border-zinc-600 dark:bg-zinc-700">PDF Analysis</span>
                                            <div className="ring-background size-7 ring-4 rounded-full bg-blue-100 dark:bg-zinc-700 flex items-center justify-center dark:ring-zinc-800">
                                                <FileText className="size-4 text-blue-600 dark:text-blue-400" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4 rounded-full bg-green-100 dark:bg-zinc-700 flex items-center justify-center dark:ring-zinc-800">
                                                <Zap className="size-5 text-green-600 dark:text-green-400" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:text-gray-200 dark:border-zinc-600 dark:bg-zinc-700">Quick Summary</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:text-gray-200 dark:border-zinc-600 dark:bg-zinc-700">Voice Chat</span>
                                            <div className="ring-background size-7 ring-4 rounded-full bg-purple-100 dark:bg-zinc-700 flex items-center justify-center dark:ring-zinc-800">
                                                <Mic className="size-4 text-purple-600 dark:text-purple-400" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
